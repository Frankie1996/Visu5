...
function checkIfGameOver() {
  ...
  if (matchCardsArray.length === 16) {
    ...
    if (starRating === 3) {
      alertMessage = 'Glückwunsch! Du hast erstaunliche Gedächtnisfähigkeiten!!';
    } else if (starRating === 2.5) {
      alertMessage = 'Gratulation! Du hast gute Gedächtnisfähigkeiten!';
    } else if (starRating === 2) {
      alertMessage = 'Du hast gewonnen! Gute Arbeit!!';
    } else if (starRating === 1.5) {
      alertMessage = 'Super! Trainier weiter, um dein Gedächtnis zu verbessern!';
    } else if (starRating === 1) {
      alertMessage = 'Tiptop! Versuche beim nächsten Mal, die passenden Karten mit weniger Zügen zu finden!';
